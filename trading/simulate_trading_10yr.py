...
# Quantitative Strategy Thresholds
PROFIT_BOOKING_THRESHOLD = 0.50  # Sell if profit hits 50%
STOP_LOSS_THRESHOLD = 0.15      # Sell if loss hits 15%
DIP_BUYING_THRESHOLD = 0.12      # Trigger dip buying if price < 12% below SMA20
MOMENTUM_BREAKOUT_THRESHOLD = 0.10 # Trigger momentum if 5-day return > 10%
MIN_CONFIDENCE_SCORE = 60        # Only buy if Confidence Score >= 60/100
